          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Have questions about our free handwriting to text converter tool? Need help understanding text extraction results? 
                We're here to help with your handwriting digitization inquiries. Send us a message and we'll respond as soon as possible.
              </p>
